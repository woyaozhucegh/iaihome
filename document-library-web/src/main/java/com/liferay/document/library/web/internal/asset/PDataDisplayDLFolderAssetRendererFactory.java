...
public class PDataDisplayDLFolderAssetRendererFactory
	extends BaseAssetRendererFactory<Folder> {

	public static final String TYPE = "document_folder";

	public PDataDisplayDLFolderAssetRendererFactory() {
	...
	public PortletURL getURLView(
		...
		LiferayPortletURL liferayPortletURL =
			liferayPortletResponse.createLiferayPortletURL(
				DLWebKeys.PRODUCTS_DATA_DISPLAY, PortletRequest.RENDER_PHASE);
