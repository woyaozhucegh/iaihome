...
public class PDataDisplayEditFileEntryTypeMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		try {
			...
			if (e instanceof NoSuchFileEntryTypeException ||
				...
				return "/products_data_display/error.jsp";
			}
			else {
		...
		return "/products_data_display/edit_file_entry_type.jsp";
	}
