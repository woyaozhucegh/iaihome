...
public class PDataDisplayEditFileEntryTypeMVCActionCommand extends BaseMVCActionCommand {
		...
		try {
			...
			if (SessionErrors.isEmpty(actionRequest)) {
				SessionMessages.add(
					...
					DLWebKeys.PRODUCTS_DATA_DISPLAY);
			...
			actionResponse.setRenderParameter(
				"mvcPath", "/products_data_display/view_file_entry_types.jsp");
		}
			...
			actionResponse.setRenderParameter(
				"mvcPath", "/products_data_display/error.jsp");
		}
	}
