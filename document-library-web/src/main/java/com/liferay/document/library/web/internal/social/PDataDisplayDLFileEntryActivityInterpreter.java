...
public class PDataDisplayDLFileEntryActivityInterpreter
	...
	protected String getFolderLink(
		...
		sb.append("/products_data_display/find_folder?groupId=");
	...
	protected String getPath(
		...
		return "/products_data_display/find_file_entry?fileEntryId=" +
			activity.getClassPK();
	}
