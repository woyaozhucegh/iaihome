...
/**
 * Provides the local service interface for Interestcategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InterestcategoryLocalServiceUtil
...
public interface InterestcategoryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InterestcategoryLocalServiceUtil} to access the interestcategory local service. Add custom service methods to {@link com.liferay.asset.interest.service.impl.InterestcategoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Interestcategory addInterestcategory(
		Interestcategory interestcategory);

	public Interestcategory addInterestCategory(long userId,
	...
	*/
	...
	public Interestcategory createInterestcategory(long interestCategoryId);
	...
	*/
	...
	public Interestcategory deleteInterestcategory(
		Interestcategory interestcategory);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Interestcategory deleteInterestcategory(long interestCategoryId)
	...
	*/
	...
	public Interestcategory fetchInterestcategory(long interestCategoryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Interestcategory fetchInterestcategoryByUuidAndGroupId(String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Interestcategory> getInterestcategories(int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Interestcategory> getInterestCategories(long userId,
		long groupId, int start, int end) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Interestcategory> getInterestCategories(long userId,
		long groupId, int start, int end,
		OrderByComparator<Interestcategory> obc) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Interestcategory> getInterestcategoriesByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Interestcategory getInterestcategory(long interestCategoryId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Interestcategory getInterestcategoryByUuidAndGroupId(String uuid,
	...
	*/
	...
	public Interestcategory updateInterestCategory(long userId,
		long interestCategoryId, ServiceContext serviceContext)
		throws PortalException, NoSuchInterestcategoryException;
}