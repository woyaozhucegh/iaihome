...
/**
 * The persistence interface for the interestcategory service.
 *
 * <p>
 ...
 * @see InterestcategoryUtil
 * @generated
 */
@ProviderType
public interface InterestcategoryPersistence extends BasePersistence<Interestcategory> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InterestcategoryUtil} to access the interestcategory persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<Interestcategory> findByUuid(String uuid);
	...
	*/
	public java.util.List<Interestcategory> findByUuid(String uuid, int start,
		int end);
	...
	*/
	public java.util.List<Interestcategory> findByUuid(String uuid, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Interestcategory> orderByComparator);
	...
	* @return the matching interestcategories
	*/
	public java.util.List<Interestcategory> findByUuid_C(String uuid,
		long companyId);
	...
	* @return the matching interestcategories
	*/
	public java.util.List<Interestcategory> findByU_G(long userId, long groupId);
	...
	* @return the range of matching interestcategories
	*/
	public java.util.List<Interestcategory> findByU_G(long userId,
	...
	*/
	public void cacheResult(java.util.List<Interestcategory> interestcategories);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Interestcategory> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<Interestcategory> findAll();
	...
	*/
	public java.util.List<Interestcategory> findAll(int start, int end);
